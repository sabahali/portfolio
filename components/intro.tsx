...
export default function Intro() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src={profile}
              alt="Sabah's Portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
              className="h-24 w-24 scale-150 mb-5 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        <span className="font-bold">Hello, I'm Sabah Ali CK.</span> <br/>I'm a{" "}
      ...
      >
        ...
        <a
          ...
          href="https://github.com/sabahali"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
